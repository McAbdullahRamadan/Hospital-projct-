...
namespace Hospital.Web.Areas.Identity.Pages.Account
{
    public class DoctorRegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public IFormFile pictuerUri { get; set; }
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Utilities.ImagesOperations image = new Utilities.ImagesOperations((_ev));
                string fileImage = image.UploadImage(Input.pictuerUri);
                user.pictuerUri = fileImage;
